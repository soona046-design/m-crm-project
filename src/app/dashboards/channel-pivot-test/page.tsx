                  ...
                  <Table size="small" stickyHeader>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell align="right"><strong>CPC</strong></TableCell>
                      ...
                      {monthlyData.map((monthRow) => (
                        <React.Fragment key={monthRow.yearMonth}>
                          ...
                          >
                            ...
                            <TableCell></TableCell>
                            <TableCell align="right"><strong>{formatNumber(monthRow.totalImpressions || 0)}</strong></TableCell>
                            <TableCell align="right"><strong>{formatNumber(monthRow.totalClicks || 0)}</strong></TableCell>
                            <TableCell align="right"><strong>{formatCurrency(monthRow.cpc || 0)}</strong></TableCell>
                            ...
                            return (
                              <React.Fragment key={weekKey}>
                                ...
                                >
                                  ...
                                  <TableCell></TableCell>
                                  <TableCell align="right"><strong>{formatNumber(weekRow.totalImpressions || 0)}</strong></TableCell>
                                  <TableCell align="right"><strong>{formatNumber(weekRow.totalClicks || 0)}</strong></TableCell>
                                  <TableCell align="right"><strong>{formatCurrency(weekRow.cpc || 0)}</strong></TableCell>
